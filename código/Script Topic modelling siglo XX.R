...
# titulos <- list.files("C:/Users/EVivoCapdevila/Desktop/Antwerpen-Valencia/Artículos/Topic modelling/Distant_reading_sigloXIX/Corpus XX/Guinea")
titulos <- list.files("C:/Users/EVivoCapdevila/Desktop/Antwerpen-Valencia/Artículos/Topic modelling/Distant_reading_sigloXIX/Corpus XX/Filipinas")
...
# Para reproducir los resultados sin recurrir al dataset tan solo es necesario descargar el corpus y sustituir las urls.
#ficheros <- list.files("C:/Users/EVivoCapdevila/Desktop/Antwerpen-Valencia/Artículos/Topic modelling/Distant_reading_sigloXIX/Corpus XX/Guinea", full.names = T)
ficheros <- list.files("C:/Users/EVivoCapdevila/Desktop/Antwerpen-Valencia/Artículos/Topic modelling/Distant_reading_sigloXIX/Corpus XX/Filipinas", full.names = T)
...
### Wordcloud adapta de Rebora (https://github.com/SimoneRebora/)
# ggplot library
library(ggwordcloud)
...
# guardarla
ggsave(p1, filename = "Topics_wordcloudFilipinasXX15.png", scale = 3.5)
...
png(filename = "FilipinasXX15heatmap.png", width = 4000, height = 4000)
...
png(filename = "FilipinasXX15heatmap_2.png", width = 1000, height = 1000)
...
resultado <- terminos_frecuentes %>%
  group_by(topic) %>%
  count(term) 
write_tsv(resultado,"ResultadosLDAFilipinasXX15.txt")
